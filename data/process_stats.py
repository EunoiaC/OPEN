...
path1 = "/Users/aadiyadav/Documents/GitHub/OPEN/data/2020-2024-gender_stats.csv"
path2 = "/Users/aadiyadav/Documents/GitHub/OPEN/data/2020-2024-world_development_indicators.csv"
output_path = "/Users/aadiyadav/Documents/GitHub/OPEN/data/processed_stats.json"
...
class CountryData:
    ...
    def add_data(self, year, name, value):
        if name not in self.data or isinstance(self.data[name], PollData) or year > self.data[name].year:
            poll = None
            if ":" in name:
